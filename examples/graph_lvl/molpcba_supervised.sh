...
dataset_name="ogbg-molpcba"  # PCQM4Mv2  ogbg-molpcba  ogbl-ddi  ogbl-ppa  ogbn-proteins
true_valid=-1  # -1  30000  10000  5000  512  128  32  0

# i. data config
tokenizer_class="StackedGSTTokenizer"  # GSTTokenizer|StackedGSTTokenizer
tokenization_config_file="graph_lvl/ogbg_molpcba_tokenization_config.json"
sampling_conf_sv="ns"
...
# ii. model config
model_name="mini"  # tiny mini small medium base base24 base48 large xlarge xxlarge
stack_method="short"
stacked_feat_agg_method="gated"
hidden_act="gelu"  # llama -> `silu`, graphformer -> `gelu`
causal_attention=0
pretrain_cpt="pt_h256_l4_b1024_tk8e9_gelu_4m_nmlm_mrlinear_mtp0.8_0_0.2_lr3e-4_adp0.1_pdp0_edp0_mdp0_lsi0_short_gated_wd0.1"
suffix_pt="_pt_b1024_tk8e9_4m_nmlm_mrlinear_mtp0.8_0_0.2_adp0.1_wd0.1"
