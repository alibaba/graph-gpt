...
# ii. model config
model_type="graphgpt"
model_name="mini"  # tiny mini small medium base base24 base48 large large48 xlarge xxlarge
stack_method="short"  # short|long
stacked_feat_agg_method="gated"  # sum|gated
...
epochs_warmup=9.6  # calculated as 32 * 0.3
seed=${trial}
...
suffix_pt="_t${trial}"  # "_pt_b1024_tk8e9_4m_nmlm_mrlinear_mtp0.8_0_0.2_adp0.1_wd0.1"
