...
dataset_source="spice-circuit"  # molecule|PCQM4Mv2
...
num_cpus=12
batch_size=128  # 256/512 for pack_tokens=0, 64 for pk=1
workerCount=1
...
suffix="_${hidden_act}_nmlm_lr${lr}_adp${attention_dropout}_pdp${path_dropout}_edp${embed_dropout}_mdp${mlp_dropout}_lsi${layer_scale_init_val}_${stack_method}_${stacked_feat_agg_method}_wd${weight_decay}"
