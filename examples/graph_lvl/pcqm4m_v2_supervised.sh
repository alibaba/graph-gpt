...
model_name="base"  # tiny mini small medium base base24 base48 large large48 xlarge xxlarge
...
ds_prefix="pcqm4m-v2"
mid_dir="202603/"
pretrain_cpt=""  # "pt_ns_h768_l24_b8192_mpe1024_tk4e9_gelu_3.3m_nmlm_mrlinear_mtp0.8_0_0.2_lr3e-4_adp0.1_pdp0_edp0_mdp0_lsi0_short_gated_wd0.1"
suffix_pt="_t${trial}"  # "_pt_b8192_tk4e9_3.3m_nmlm_mrlinear_mtp0.8_0_0.2_adp0.1_wd0.1"
