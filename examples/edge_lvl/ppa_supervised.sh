...
sampling_conf="d1n14"  # source: sampling_conf_sv

tokenizer_class="StackedGSTTokenizer"  # GSTTokenizer|StackedGSTTokenizer
token_cfg_dir="edge_lvl/"
token_cfg_file="ogbl_ppa"
...
batch_size=256
true_valid=-1  # -1  30000  10000  5000  0
...
mid_dir="202512/"
pretrain_cpt=""
suffix_pt="_50percent_bf16_pt_none"
...
## exceptions
if [ "${model_name}" = "xxlarge" ]
  then
    lr=2e-5
    deepspeed_config="./script/ds_config2_bf16.json"
