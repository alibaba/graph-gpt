...
# CAUTION: in tokenization_config.json, set `sampling`->`edge_ego`->`method`->`name` to `local`
...
# ii. model config
model_name="medium"  # tiny mini small medium base base24 base48 large xlarge xxlarge
stack_method="short"
stacked_feat_agg_method="gated"
hidden_act="gelu"  # llama -> `silu`, graphformer -> `gelu`
causal_attention=0
pretrain_cpt="pt_d1n14_h768_l12_b2048_mpe1024_tk2e10_bf16_gelu_nmlm_mrlinear_mtp0.8_0_0.2_lr1e-4_adp0.1_pdp0_edp0_mdp0_lsi0_short_gated_wd0.1_norm1"
suffix_pt="_10percent_samp_tails_nr1_pt_b2048_tk2e10"
