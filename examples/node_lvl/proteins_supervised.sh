...
dataset_name="ogbn-proteins"  # PCQM4Mv2  ogbg-molpcba  ogbl-ddi  ogbl-ppa  ogbn-proteins
true_valid=-1  # -1  30000  10000  5000  512  128  32  0

# i. data config
tokenizer_class="StackedGSTTokenizer"  # GSTTokenizer|StackedGSTTokenizer
tokenization_config_file="node_lvl/ogbn_proteins_tokenization_config.json"
sampling_conf_sv="d20n1"

epochs=16
warmup_rate=0.3
epochs_warmup=$(bc <<<"scale=2;${epochs}*${warmup_rate}")

num_cpus=20  # -> consume too much cpu memory
batch_size=128
workerCount=1
...
stack_method="long"
stacked_feat_agg_method="gated"  # sfam -> gated|sum
hidden_act="gelu"  # llama -> `silu`, graphformer -> `gelu`
causal_attention=0
pretrain_cpt="pt_d16n1_h768_l12_b1024_mpe1024_tk2e10_gelu_nmlm_mrlinear_mtp0.8_0_0.2_lr3e-4_adp0.1_pdp0.1_edp0.1_mdp0_lsi0_gated_eulerlong_wd0.1_sharevocab"
suffix_pt="_sfam_${stacked_feat_agg_method}_pt_d16n1_b1024_tk1.2e10_eulerlong_sharevocab"
