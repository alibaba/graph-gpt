...
dataset_name="ogbn-products"  # PCQM4Mv2  ogbg-molpcba  ogbl-ddi  ogbl-ppa  ogbn-proteins
...
# ii. model config
model_name="mini"  # tiny mini small small12 medium medium24 medium48 base base24 base48 base64 large large48 xlarge xxlarge
stack_method="short"
stacked_feat_agg_method="sum"  # sfam -> gated|sum
hidden_act="gelu"  # llama -> `silu`, graphformer -> `gelu`
causal_attention=0
pretrain_cpt=""
suffix_pt="_sfam_${stacked_feat_agg_method}_trial${trial}_no_x"
